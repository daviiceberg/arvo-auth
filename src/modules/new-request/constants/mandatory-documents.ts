...
export const DOCS_TERAPIAS_CONTINUIDADE: { nome: string; descricao: string; obrigatorio: boolean }[] = [
  { nome: 'Pedido Médico com CID', descricao: 'Solicitação assinada pelo médico responsável', obrigatorio: true },
...
export const DOCS_OBRIGATORIOS: Record<ModuloType, { nome: string; descricao: string; obrigatorio: boolean }[]> = {
