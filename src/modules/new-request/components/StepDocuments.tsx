...
export function StepDocuments({
  modulo, docsObrigatorios, docsAdicionais, pendentesObrig,
  showAddDocForm, setShowAddDocForm,
  newDocTipo, setNewDocTipo,
  newDocFile, setNewDocFile,
  newDocDescricao, setNewDocDescricao,
  docDragOver, setDocDragOver,
  docFileRef,
  handleObrigUpload, handleRemoveObrigDoc,
  handleAddDocAdicional, handleRemoveDocAdicional, cancelAddDoc,
}: StepDocumentsProps) {
      ...
      {showAddDocForm ? (
        <Box sx={{ border: '1px solid rgba(0,0,0,0.12)', borderRadius: 2, p: 2, backgroundColor: '#fafafa' }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            <Button size="small" variant="outlined" onClick={cancelAddDoc}>Cancelar</Button>
