...
export function StepTherapies({
  ...
  return (
    <Box>
        ...
        {form.etapaAutorizacao === 'continuidade' && (
          <Grid size={{ xs: 12 }}>
            <Alert severity="info" sx={{ fontSize: 13 }}>
              Renovação exige Relatório de Evolução Terapêutica emitido pelo profissional
              executante. Verifique o anexo na etapa Documentos.
            </Alert>
          </Grid>
        )}
      </Grid>
            ...
            <Grid container spacing={2} sx={{ px: 2, pb: 2 }}>
              <Grid size={{ xs: 6 }}>
                ...
                <FormControl fullWidth size="small">
                  <Select
                    ...
                    onChange={(e) => {
                      handleUpdateTerapiaProc(proc.id, 'tipoTerapia', e.target.value);
                    }}
                    displayEmpty
                  >
                    <MenuItem value="" disabled>
                    ...
                    <MenuItem value="ABA / Análise do Comportamento">
              ...
              <Grid size={{ xs: 6 }}>
                ...
                <TextField
                  ...
                  size="small"
                  type="number"
                  value={proc.numeroSessoes}
                  onChange={(e) => {
                    handleUpdateTerapiaProc(proc.id, 'numeroSessoes', e.target.value);
                  }}
                />
              </Grid>
              <Grid size={{ xs: 6 }}>
              ...
              <Grid size={{ xs: 6 }}>
                ...
                <FormControl fullWidth size="small">
                  <Select
                    value={proc.frequenciaSemanal}
                    onChange={(e) => {
                      handleUpdateTerapiaProc(proc.id, 'frequenciaSemanal', e.target.value);
                    }}
                  >
      ...
      <Tooltip
        title={terapiaProcedimentos.length >= 5 ? 'Máximo de 5 procedimentos por solicitação' : ''}
        placement="top"
      >
        <span>
          <Button
