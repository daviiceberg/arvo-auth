      ...
      <Grid container spacing={2}>
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          <FormControl fullWidth size="small">
            <Select
              value={form.tipoAcomodacao}
              onChange={(e) => {
                setSelect('tipoAcomodacao')(e.target.value);
              }}
            >
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          <TextField
            ...
            size="small"
            type="number"
            value={form.qtdDiarias}
            onChange={set('qtdDiarias')}
          />
        </Grid>
        <Grid size={{ xs: 12, md: 6 }}>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          ...
          <FormControl fullWidth size="small">
            <Select
              ...
              onChange={(e) => {
                setSelect('regimeInternacao')(e.target.value);
              }}
            >
