      ...
      <CardContent sx={{ p: 3 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 2, mb: 2 }}>
          ...
          <Button
            size="small"
            variant="outlined"
            onClick={() => { router.push(`/fila?beneficiario=${encodeURIComponent(b.name)}`); }}
        ...
        <Box sx={{ display: 'flex', gap: 4, flexWrap: 'wrap', pt: 2.5, mt: 2, borderTop: '1px solid rgba(0,0,0,0.08)' }}>
          ...
          <Box>
            ...
            <Typography variant="body2" fontWeight={600} sx={{ fontSize: 13, color: b.waitingPeriod ? '#b45309' : '#16a34a' }}>
