...
const DEFAULT_BY_CATEGORY: Record<Category, ConsolidatedHistory> = {
...
/**
 * Resolve histórico consolidado para um Request da fila operacional.
 * Prioridade: mock específico por ID > default por categoria > DEFAULT_HISTORY (TEA).
 */
export function resolveConsolidatedHistory(ref: ConsolidatedHistoryRef): ConsolidatedHistory {
