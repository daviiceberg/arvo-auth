    ...
    procedures: [
      {
        code: '98912032',
        tuss: '98912032',
        description: 'PCT - Angioplastia Coronária',
        qty: 1,
        authorizedQty: undefined,
        ...
        packageId: 'pkg-angio',
        tussCodesIncluded: [
          { code: '30912032', description: 'Angioplastia transluminal', tableNumber: 22 },
          { code: '30912024', description: 'Cateterismo diagnóstico', tableNumber: 22 },
          { code: '30912040', description: 'Implante de stent coronariano', tableNumber: 22 },
        ],
      },
      {
        code: '30718014',
        tuss: '30718014',
        description: 'Diárias de UTI adulto',
        qty: 3,
        authorizedQty: undefined,
        startDate: '05/04/2026',
        endDate: '07/04/2026',
      ...
      },
      {
        code: '70740015',
        tuss: '70740015',
        description: 'Stent farmacológico — Fabricante X',
        qty: 2,
        authorizedQty: undefined,
        startDate: '05/04/2026',
        endDate: '05/04/2026',
    ...
    procedures: [
      {
        code: '98911044',
        tuss: '98911044',
        description: 'PCT - Cateterismo coronariano',
        qty: 1,
        authorizedQty: undefined,
  ...
  },
  {
    ...
    procedures: [
      ...
      },
      {
        code: '40304020',
        tuss: '40304020',
        description: 'Oximetria de pulso contínua',
        qty: 5,
        authorizedQty: 5,
        startDate: '24/03/2026',
        endDate: '28/03/2026',
    ...
    procedures: [
      {
        code: '98907500',
        tuss: '98907500',
        description: 'PCT - Imunoterapia — Ciclo Pembrolizumabe',
        qty: 1,
        authorizedQty: undefined,
        ...
        packageId: 'pkg-imuno',
        tussCodesIncluded: [
          { code: '90020055', description: 'Pembrolizumabe 200mg EV', tableNumber: 22 },
          { code: '90020018', description: 'Infusão EV em hospital-dia', tableNumber: 22 },
          { code: '20101015', description: 'Hemograma pré-ciclo', tableNumber: 22 },
        ],
      },
      {
        code: '20201015',
      ...
      },
      {
        code: '20501017',
        tuss: '20501017',
        description: 'TSH ultrassensível',
        qty: 1,
        authorizedQty: undefined,
        startDate: '09/04/2026',
        endDate: '09/04/2026',
...
export const historicoEntries: HistoryEntry[] = [
  ...
  },
  {
    ...
    detailedProcedures: [
      ...
      },
      {
        code: '50000471',
        tuss: '50000471',
        description: 'Terapia ABA — Análise Comportamental Aplicada',
        qty: 16,
        authorizedQty: 16,
        startDate: '01/03/2026',
        endDate: '31/03/2026',
    ...
    detailedProcedures: [
      {
        code: '98913101',
        tuss: '98913101',
        description: 'Pacote - Artroplastia Total de Joelho',
        qty: 1,
        authorizedQty: 1,
        ...
        packageId: 'pkg-atj',
        tussCodesIncluded: [
          { code: '30913101', description: 'Artroplastia total de joelho', tableNumber: 22 },
          { code: '30913128', description: 'Material cirúrgico joelho', tableNumber: 22 },
          { code: '30907136', description: 'Anestesia geral', tableNumber: 22 },
        ],
      },
      {
        code: '30718014',
        tuss: '30718014',
        description: 'Diárias de enfermaria',
        qty: 4,
        authorizedQty: 4,
        startDate: '06/03/2026',
        endDate: '09/03/2026',
      ...
      },
      {
        code: '20101015',
        tuss: '20101015',
        description: 'Hemograma completo pré-operatório',
        qty: 1,
        authorizedQty: 1,
    ...
    detailedProcedures: [
      {
        ...
        tussCodesIncluded: [
          ...
          { code: '30911052', description: 'Angioplastia coronariana', tableNumber: 22 },
          { code: '30911060', description: 'Implante de stent coronariano', tableNumber: 22 },
          { code: '30911079', description: 'Ventriculografia esquerda', tableNumber: 22 },
          { code: '30911087', description: 'Aortografia', tableNumber: 22 },
          { code: '30911095', description: 'Monitorização hemodinâmica', tableNumber: 22 },
        ],
      },
      {
        code: '30507026',
  ...
  // ── HIS-2026-0043 (OPME — Pacote negado) ──────────────────────────────
  {
    id: 'HIS-2026-0043',
    beneficiary: 'Marcos Henrique Barros',
    cardNumber: '9988776655443322',
    plan: 'Gold',
    category: 'OPME' as const,
    procedure: 'PCT - Angioplastia Coronária + Stent farmacológico',
    cid: 'I25.1',
    provider: 'Hospital do Coração',
    requestingDoctor: 'Dr. Ricardo Ferraz',
    guideType: 'Eleitiva' as const,
    protocolDate: '10/03/2026 09:30',
    decisionDate: '15/03/2026 14:20',
    action: 'Negado' as const,
    origin: 'analista' as const,
    analyst: 'Paulo Rocha',
    decisionReason:
      'Indicação clínica insuficiente. Teste funcional não demonstra isquemia significativa. Recomendado tratamento clínico otimizado antes de intervenção.',
    iaSuggestion: 'Negar' as const,
    divergence: false,
    analysisTimeMin: 22,
    sex: 'M' as const,
    age: 62,
    ...
    alerts: [],
    iaChecklist: [
      { texto: 'Teste ergométrico positivo', status: 'warning' as const },
      { texto: 'Cineangiocoronariografia realizada', status: 'ok' as const },
      { texto: 'Ecocardiograma com FE > 50%', status: 'ok' as const },
      { texto: 'Teste funcional demonstra isquemia', status: 'error' as const },
    ],
    documents: [
      { nome: 'Cineangiocoronariografia.pdf', tipo: 'Exame', data: '08/03/2026 11:00' },
      { nome: 'Laudo Cardiológico.pdf', tipo: 'Laudo Médico', data: '09/03/2026 16:30' },
    ],
  },
  // ── HIS-2026-0044 (Cirurgias — Pacote aprovado com divergência) ────────
  {
    id: 'HIS-2026-0044',
    beneficiary: 'Sonia Maria Ferreira',
    cardNumber: '5566778899001122',
    plan: 'Premium',
    category: 'Cirurgias Eletivas' as const,
    procedure: 'Pacote - Histeroscopia com Ressectoscópio + Diárias + Monitorização',
    cid: 'N85.0',
    provider: 'Hospital Sírio-Libanês',
    requestingDoctor: 'Dra. Marina Alves',
    guideType: 'Eleitiva' as const,
    protocolDate: '12/03/2026 08:00',
    decisionDate: '16/03/2026 11:45',
    action: 'Aprovado' as const,
    origin: 'analista' as const,
    analyst: 'Ana Paula Santos',
    decisionReason:
      'Indicação compatível com quadro clínico. Sangramento uterino anormal refratário ao tratamento conservador.',
    iaSuggestion: 'Negar' as const,
    divergence: true,
    divergenceReason:
      'IA sugeriu negar por ausência de biópsia endometrial prévia, mas analista considerou USG transvaginal + histeroscopia diagnóstica como evidência suficiente.',
    analysisTimeMin: 35,
    sex: 'F' as const,
    age: 48,
    cpf: '987.654.321-00',
    ...
    detailedProcedures: [
      {
        code: '98303188',
        tuss: '98303188',
        description: 'Pacote - Histeroscopia com Ressectoscópio',
        qty: 1,
        authorizedQty: 1,
        startDate: '16/03/2026',
        endDate: '16/03/2026',
        ...
        auditLevel: 'HOSPITALAR' as const,
        codeType: 'PACKAGE' as const,
        packageId: 'pkg-histeroscopia',
        tussCodesIncluded: [
          {
            code: '31303188',
            description: 'Histeroscopia cirúrgica com ressectoscópio',
            tableNumber: 22,
          },
          { code: '31303170', description: 'Histeroscopia diagnóstica', tableNumber: 22 },
        ],
      },
      {
        code: '30718014',
        tuss: '30718014',
        description: 'Diárias de hospital-dia',
        qty: 1,
        authorizedQty: 1,
        startDate: '16/03/2026',
        endDate: '16/03/2026',
      ...
      },
      {
        code: '40304020',
        tuss: '40304020',
        description: 'Monitorização anestésica',
        qty: 1,
        authorizedQty: 1,
        startDate: '16/03/2026',
        endDate: '16/03/2026',
    ...
    alerts: [],
    iaChecklist: [
      { texto: 'Indicação cirúrgica documentada', status: 'ok' as const },
      { texto: 'Biópsia endometrial prévia', status: 'error' as const },
      { texto: 'USG transvaginal recente', status: 'ok' as const },
      { texto: 'Anestesista designado', status: 'ok' as const },
    ],
    documents: [
      { nome: 'USG Transvaginal.pdf', tipo: 'Exame', data: '10/03/2026 09:00' },
      { nome: 'Histeroscopia Diagnóstica.pdf', tipo: 'Exame', data: '11/03/2026 14:20' },
    ],
  },
  // ── HIS-2026-0045 (Internação — Múltiplos TUSS, aprovado por IA) ──────
  {
    id: 'HIS-2026-0045',
    beneficiary: 'José Alberto Pinto',
    cardNumber: '1122334455667788',
    plan: 'Básico',
    category: 'Internação' as const,
    procedure: 'Internação clínica + Visita hospitalar + Hemograma + Oximetria + Eletrólitos',
    cid: 'J18.9',
    provider: 'Hospital Municipal São Paulo',
    requestingDoctor: 'Dr. André Luiz Costa',
    guideType: 'Urgente' as const,
    protocolDate: '17/03/2026 06:30',
    decisionDate: '19/03/2026 08:00',
    action: 'Aprovado' as const,
    origin: 'ia_automatica' as const,
    analyst: 'IA Automática',
    decisionReason:
      'Pneumonia comunitária com critérios de internação (SpO2 < 93%, PSI score IV). Todos os procedimentos solicitados são compatíveis com protocolo institucional.',
    iaSuggestion: 'Aprovar' as const,
    divergence: false,
    analysisTimeMin: 0,
    sex: 'M' as const,
    age: 73,
    ...
    detailedProcedures: [
      {
        code: '40301010',
        tuss: '40301010',
        description: 'Internação em enfermaria clínica',
        qty: 7,
        authorizedQty: 7,
        startDate: '17/03/2026',
        endDate: '23/03/2026',
      ...
      },
      {
        code: '20501039',
        tuss: '20501039',
        description: 'Dosagem de eletrólitos',
        qty: 2,
        authorizedQty: 2,
        startDate: '17/03/2026',
        endDate: '23/03/2026',
    ...
    alerts: [],
    iaChecklist: [
      { texto: 'Critérios de internação preenchidos (PSI IV)', status: 'ok' as const },
      { texto: 'SpO2 < 93% na admissão', status: 'ok' as const },
      { texto: 'Beneficiário elegível e sem carência', status: 'ok' as const },
      { texto: 'Prestador credenciado', status: 'ok' as const },
    ],
    documents: [
      { nome: 'Laudo de Internação.pdf', tipo: 'Laudo Médico', data: '17/03/2026 07:00' },
      { nome: 'Hemograma Admissão.pdf', tipo: 'Exame', data: '17/03/2026 08:30' },
    ],
  },
];
